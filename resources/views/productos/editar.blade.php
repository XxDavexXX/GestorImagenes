                ...
                @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div calss="grid grid-cols-1">
                            ...
                            <input type="text" value="{{ $producto->nombre }}" name="nombre" class="py-2 px-3 rounded-lg border-2 border-purple-300 focus:outline-none focus:ring-2 focus:purple-600 w-full" placeholder="nombre del producto">
                        </div>   
                        <div calss="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-gary-500 text-light font-semibold">Descripcion</label>
                            <input type="text" value="{{ $producto->descripcion }}" name="descripcion" class="py-2 px-3 rounded-lg border-2 border-purple-300 focus:outline-none focus:ring-2 focus:purple-600 w-full" placeholder="descripcion del producto">
                        </div> 
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        
                        <p>Imagen Actual:</p>
                        <img src="/imagen/{{ $producto->imagen }}" width="40%" >
